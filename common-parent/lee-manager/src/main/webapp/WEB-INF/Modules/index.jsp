...
<head>
    ...
    <meta content="金融后台管理系统" name="description"/>
    <title>活动易后台管理系统</title>
            ...
            <header>
                ...
                <div class="header_tab">
                    <ul>
                        ...
                        <li class="password_nav"><a href="${pageContext.request.contextPath}/user/update"
                ...
                <ul id="showMainNav" class="fix">
                    ...
                    <li class="navContent">
                        <a href="#" class="showNav" id="finance" data-name="main_iframe"
                           onclick="Common.switchNavigation(this);"
                           data-url="${pageContext.request.contextPath}/user/info">工资管理</a>
                    </li>
                </ul>
            </nav>
        </div>
